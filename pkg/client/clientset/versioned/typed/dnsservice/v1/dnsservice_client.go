...
import (
	...
	"dnsservice-controller/pkg/client/clientset/versioned/scheme"
...
// TrstringerV1Client is used to interact with features provided by the io.bb.com.br group.
type TrstringerV1Client struct {
	restClient rest.Interface
}

func (c *TrstringerV1Client) DnsServices(namespace string) DnsServiceInterface {
	return newDnsServices(c, namespace)
}
